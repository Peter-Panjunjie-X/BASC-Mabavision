...
optim_wrapper = dict(
    ...
    optimizer=dict(
        ...
        type='AdamW', lr=0.00009, betas=(0.9, 0.999), weight_decay=0.01),
    paramwise_cfg=dict(
        custom_keys={
...
# CUDA_VISIBLE_DEVICES=0 python semantic_segmentation/tools/train.py --config semantic_segmentation/configs/mamba_vision/farmland_mamba_vision_160k_ade20k-512x512_small_BASC_lov.py  --work-dir ./work_dir/farmland_mamba_small_BASC_lov  --amp 

# python semantic_segmentation/tools/test.py semantic_segmentation/configs/mamba_vision/farmland_mamba_vision_160k_ade20k-512x512_small_BASC_lov.py  work_dir/farmland_mamba_small_BASC_lov/iter_12000_7588.pth
