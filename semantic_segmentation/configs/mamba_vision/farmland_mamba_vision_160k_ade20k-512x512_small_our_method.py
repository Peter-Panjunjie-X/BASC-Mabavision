...
# CUDA_VISIBLE_DEVICES=1 python semantic_segmentation/tools/train.py --config semantic_segmentation/configs/mamba_vision/farmland_mamba_vision_160k_ade20k-512x512_small_our_method.py  --work-dir ./work_dir/farmland_mamba_small_our_method  --amp 
